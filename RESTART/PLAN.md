...
5. Define PDE-priority correctness metrics and error diagnostics.
6. Build deterministic theorem-constrained sensitivity in `heat1d_lchs_sensitivity.py`.
7. Document full derivation and experiment protocol in `HEAT1D_LCHS_EXPERIMENT.tex`.
