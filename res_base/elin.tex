...
\subsection{Linear 1st-order PDE:  Heat equations}
\subsubsection{Discretized One-dimensional Heat Equation}
\label{1d-heat}
...
\subsection{Continuous-discrete variable Laplace transform-based quantum eigenvalue transformation (QEVT)}
